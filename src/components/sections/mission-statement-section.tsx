      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative z-10 text-center flex flex-col items-center">
          ...
          <motion.h2
            ...
            className="font-display font-bold uppercase text-3xl lg:text-[5.5rem] leading-tight text-primary mb-6"
          >
            OUR VISION & MISSION
          </motion.h2>
          <motion.p
            ...
            className="font-body text-lg text-primary max-w-5xl text-sm md:text-2xl mx-auto mb-8"
          >
